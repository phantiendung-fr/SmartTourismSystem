...
CREATE TABLE LOCATION_SUBMISSIONS (
    ...
    ENTERPRISE_ID   UUID            NOT NULL REFERENCES ENTERPRISE_PROFILES(ENTERPRISE_ID) ON DELETE CASCADE,
...
CREATE TABLE LOCATION_VERIFICATION_LOGS (
    LOG_ID          SERIAL          PRIMARY KEY,
    SUBMISSION_ID   UUID            NULL REFERENCES LOCATION_SUBMISSIONS(SUBMISSION_ID) ON DELETE SET NULL,
    LOCATION_ID     UUID            NULL REFERENCES LOCATIONS(LOCATION_ID) ON DELETE SET NULL,
    ADMIN_ID        UUID            NULL REFERENCES USERS(USER_ID) ON DELETE SET NULL,
